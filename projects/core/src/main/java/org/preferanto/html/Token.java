...
public class Token {
    ...
    public String spanify(String cssClass) {
       return "<SPAN CLASS='" + cssClass + "'>" + image + "</SPAN>";
    }

    public String translateWhitespace() {
      return image.replace("\n", "<BR/>\n").replace(" ", "&nbsp;").replace(" ", "&nbsp;&nbsp;");
    }

    public String htmlEscape() {
        StringBuffer res = new StringBuffer();
        StringCharacterIterator i = new StringCharacterIterator(image);
        for (char c = i.current(); c != CharacterIterator.DONE; ){
          if (c == '<') {
            res.append("&lt;");
          } else if (c == '>') {
            res.append("&gt;");
