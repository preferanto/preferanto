...
public class EpsilonBoxDominanceArchive extends NondominatedPopulation {
	...
	public EpsilonBoxDominanceArchive(double epsilon) {
		super(new PopulationIndependentDominanceComparatorProvider(new EpsilonBoxDominanceComparator(epsilon)));
	}
	...
	public EpsilonBoxDominanceArchive(double epsilon,
		...
		super(new PopulationIndependentDominanceComparatorProvider(new EpsilonBoxDominanceComparator(epsilon)), iterable);
	}
	...
	public EpsilonBoxDominanceArchive(EpsilonBoxDominanceComparator comparator) {
		super(new PopulationIndependentDominanceComparatorProvider(comparator));
	}
	...
	public EpsilonBoxDominanceArchive(EpsilonBoxDominanceComparator comparator,
			Iterable<? extends Solution> iterable) {
		super(new PopulationIndependentDominanceComparatorProvider(comparator), iterable);
	}
	...
	public boolean add(Solution newSolution) {
		...
		DominanceComparatorProvider comparatorProvider = getDominanceComparatorProvider();
		if(comparatorProvider.isPopulationDependent()) {
			throw new IllegalArgumentException("EpsilonBoxDominanceArchive cannot be used with population dependent comparators ");
		}
		EpsilonBoxDominanceComparator comparator = (EpsilonBoxDominanceComparator)comparatorProvider.getComparator(null);
