...
//	}
	 ...
	 *        population
	 */
	public NondominatedPopulation(DominanceComparatorProvider comparatorProvider) {
		super();
...
//	}
	 ...
	 *        population
	 */
	public NondominatedPopulation(DominanceComparatorProvider comparatorProvider, Iterable<? extends Solution> iterable) {
		this(comparatorProvider);
		addAll(iterable);
	}
	...
	public boolean add(Solution newSolution) {
		...
		if(comparatorProvider.isPopulationDependent()) {
			tmpPop = new Population(this);
			tmpPop.add(newSolution);
		}
		DominanceComparator comparator = comparatorProvider.getComparator(tmpPop);
	 ...
	 */
	public DominanceComparatorProvider getDominanceComparatorProvider() {
