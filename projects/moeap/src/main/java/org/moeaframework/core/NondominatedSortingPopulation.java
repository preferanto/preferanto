...
//	}
	 ...
	 */
	public NondominatedSortingPopulation(DominanceComparatorProvider comparatorProvider) {
		super();

		modified = false;
		fastNondominatedSorting = new FastNondominatedSorting(comparatorProvider);
	}
