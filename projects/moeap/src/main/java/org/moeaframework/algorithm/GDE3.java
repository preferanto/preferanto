...
public class GDE3 extends AbstractEvolutionaryAlgorithm {
	...
	public void iterate() {
		...
		Population allSolutions = new Population(population);
		allSolutions.addAll(children);
		DominanceComparator comparator = comparatorProvider.getComparator(allSolutions);
