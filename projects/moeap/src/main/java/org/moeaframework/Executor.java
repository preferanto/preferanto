...
public class Executor extends ProblemBuilder {
	...
	@Override
	public Executor withPreferenceComparatorProvider(DominanceComparatorProvider preferenceComparatorProvider) {
		return (Executor)super.withPreferenceComparatorProvider(preferenceComparatorProvider);
	}
